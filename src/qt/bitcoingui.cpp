...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Anokas address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and anokas: URIs)"));
    ...
    TransferAssetsAction->setStatusTip(tr("Transfer assets to ANOK addresses"));
    ...
    aboutAction->setStatusTip(tr("Show information about Anokas Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Anokas addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Anokas addresses"));
    ...
    openAction->setStatusTip(tr("Open a anokas: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Anokas command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::createToolBars()
{
    ...
    if(walletFrame)
    {
        ...
        // Add Anokas logo on the right side
        QWidget* spacer = new QWidget();
        spacer->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
        toolbar->addWidget(spacer);

        QLabel *logoLabel = new QLabel();
        QPixmap logoPixmap(":/images/anokas_logo_toolbar");
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Anokas network", "", count));
    } else {
...
{
    QString strTitle = tr("Anokas Core"); // default title
...
void BitcoinGUI::checkAssets()
{
    ...
    if(AreAssetsDeployed()) {
        ...
        TransferAssetsAction->setToolTip(tr("Transfer assets to ANOK addresses"));
