...
CAmount AmountFromValue(const UniValue& value, bool p_isANOK)
{
...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    return "Anokas Core server stopping";
}
...
{
    return "> anokas-cli " + methodname + " " + args + "\n";
}
