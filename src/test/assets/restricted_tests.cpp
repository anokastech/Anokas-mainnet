...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler anok tx
        CScript anokTransfer = GetScriptForDestination(DecodeDestination(Params().GlobalBurnAddress()));
        CTxOut anokOut(1*COIN, anokTransfer);
        ...
        mutTxTest1.vout.emplace_back(anokOut); 
        ...
        mutTxTest2.vout.emplace_back(anokOut);
        ...
        mutTxTest3.vout.emplace_back(anokOut);
        ...
        mutTxTest4.vout.emplace_back(anokOut);
        ...
        mutTxTest5.vout.emplace_back(anokOut);
        ...
        mutTxTest6.vout.emplace_back(anokOut);
        ...
        mutTxTest7.vout.emplace_back(anokOut);
        ...
        mutTxTest8.vout.emplace_back(anokOut);
