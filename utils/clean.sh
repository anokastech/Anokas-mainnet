...
rm -f src/config/anokas-config.h
...
rm -rf test_bitcoin.coverage/ anokas-gtest.coverage/ total.coverage/
...
clean_exe src/anokas-cli
clean_exe src/anokasd
clean_exe src/anokas-gtest
clean_exe src/anokas-tx
clean_exe src/test/test_anokas
clean_exe src/test/test_anokas_fuzzy
...
clean_dep . src/config/anokas-config.h.in
