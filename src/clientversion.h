...
#error Client version information missing: version is not defined by anokas-config.h or in any other way
#endif
...
/**
 * anokasd-res.rc includes this file, but it cannot cope with real c++ code.
