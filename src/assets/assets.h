...
#ifndef ANOKASCOIN_ASSET_PROTOCOL_H
#define ANOKASCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_ANOKAS_ASSET ANOKQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_ANOKAS_ASSET ANOKO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_ANOKAS_ASSET ANOKR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_ANOKAS_ASSET ANOKT
...
#endif //ANOKASCOIN_ASSET_PROTOCOL_H
