    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  anokas-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Anokas in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.1 ANOK, 1 ANOK, 10 ANOK, 100 ANOK and 1000 ANOK -- sort of like the paper money you use every day.</li> \
