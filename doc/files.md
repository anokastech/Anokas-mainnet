...
* anokas.conf: contains configuration settings for anokasd or anokas-qt
* anokasd.pid: stores the process id of anokasd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by anokasd or anokas-qt
