...
"""Verify that starting anokasd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start anokasd with -h for help text")
        ...
        self.log.info("Start anokasd with -version for version information")
