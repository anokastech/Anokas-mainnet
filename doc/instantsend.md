...
This mechanism has been integrated into Bitcore-Node-Anokas which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/anokas/insight-api-anokas#web-socket-api](https://github.com/anokas/insight-api-anokas#web-socket-api)
* API: [https://github.com/anokas/insight-api-anokas#instantsend-transactions](https://github.com/anokas/insight-api-anokas#instantsend-transactions)
