...
from test_framework.test_framework import AnokasTestFramework
...
class LLMQCoinbaseCommitmentsTest(AnokasTestFramework):
    def set_test_params(self):
        self.set_anokas_test_params(6, 5, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as AnokasTestFramework doesn't support this atm)
