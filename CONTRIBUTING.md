Contributing to Anokas Core
============================

The Anokas Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/The-Anokas-Endeavor/anokas/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Anokas Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Anokas
Network Protocol consensus changes.

Whether a pull request is merged into Anokas Core rests with the project merge
...
Patches that change Anokas consensus rules are considerably more involved than
...
Where a patch set proposes to change the Anokas consensus, it must have been
...
The review process is normally fairly responsive on the Anokas Core repository, however
...
The project leader is the release manager for each Anokas Core release.
